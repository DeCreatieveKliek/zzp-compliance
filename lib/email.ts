...
export async function sendPasswordResetEmail(
  ...
  await resend.emails.send({
    from: 'ZZP Compliance <noreply@zzpcompliance.nl>',
    to,
        ...
        <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; background: #f8fafc; margin: 0; padding: 40px 20px;">
          <div style="max-width: 480px; margin: 0 auto; background: white; border-radius: 16px; border: 1px solid #e2e8f0; overflow: hidden;">
            <div style="background: linear-gradient(135deg, #2563eb, #4f46e5); padding: 32px; text-align: center;">
              <p style="color: white; font-size: 22px; font-weight: 900; margin: 0;">ZZP Compliance</p>
            </div>
            <div style="padding: 32px;">
              ...
              <p style="color: #374151; font-size: 14px; line-height: 1.6; margin: 0 0 24px;">
                We hebben een verzoek ontvangen om het wachtwoord van uw ZZP Compliance account opnieuw in te stellen. Klik op de knop hieronder om een nieuw wachtwoord in te stellen.
              </p>
